...
const legalContent={
  privacy:`
    <p class="legal-draft">Редакция от 27 августа 2026 года</p>
    ...
    <p>Оператор персональных данных: Музенитов Иван Георгиевич, ИНН 582102782490. Адрес: 440067, Пензенская область, р. п. Лунино, ул. Ломоносова, д. 50. Телефон: <a href="tel:+79875149977">+7 987 514-99-77</a>. Адрес для обращений по вопросам персональных данных: <a href="mailto:ivan-muzenitov@yandex.ru">ivan-muzenitov@yandex.ru</a>.</p>
    ...
    <p>После подключения формы заявки будут направляться оператору по адресу <a href="mailto:ivan_muzenitov@mail.ru">ivan_muzenitov@mail.ru</a>. Для работы сайта и доставки заявок оператор вправе привлекать российских поставщиков хостинга и электронной почты только в объёме, необходимом для оказания соответствующих технических услуг.</p>
    ...
    <p>Оператор принимает необходимые правовые, организационные и технические меры: ограничивает доступ к данным, использует защищённое соединение после публикации сайта, контролирует доступ к почте и серверу, обновляет программное обеспечение и удаляет данные после истечения срока обработки. При инцидентах оператор действует в порядке и сроки, установленные законодательством.</p>
    ...
    <p class="legal-note"><strong>Будет завершено перед публикацией:</strong> проверка домена и даты начала обработки, точного обработчика формы, владельцев хостингового и почтового сервисов, места хранения технических журналов, внешних ресурсов сайта (включая загрузку шрифтов) и подачи уведомления в Роскомнадзор. До завершения этой проверки форма не должна принимать реальные заявки.</p>
  `,
  terms:`
    <p class="legal-draft">Редакция от 27 августа 2026 года</p>
    ...
    <p>Музенитов Иван Георгиевич, ИНН 582102782490. Адрес: 440067, Пензенская область, р. п. Лунино, ул. Ломоносова, д. 50. Телефон: <a href="tel:+79875149977">+7 987 514-99-77</a>. Электронная почта: <a href="mailto:ivan-muzenitov@yandex.ru">ivan-muzenitov@yandex.ru</a>.</p>

    <p class="legal-note"><strong>Будет завершено перед публикацией:</strong> указание даты вступления Соглашения в силу и финальная сверка с фактическим доменом, работой формы и опубликованными условиями услуг.</p>
  `,
  consent:`
    <p class="legal-draft">Отдельное согласие пользователя</p>
    ...
    <div class="legal-summary">
      <div><span>Оператор</span><strong>Музенитов Иван Георгиевич</strong></div>
      <div><span>ИНН</span><strong>582102782490</strong></div>
      <div><span>Адрес</span><strong>440067, Пензенская область, р. п. Лунино, ул. Ломоносова, д. 50</strong></div>
    ...
    <p>После технического подключения формы заявка будет направляться оператору по адресу <a href="mailto:ivan_muzenitov@mail.ru">ivan_muzenitov@mail.ru</a>. Для хостинга сайта и доставки письма могут привлекаться российские технические поставщики на основании законодательства и договоров с оператором.</p>
    ...
    <p class="legal-note"><strong>Будет завершено перед публикацией:</strong> указание окончательной даты начала действия, точных технических поставщиков и проверка маршрута заявки. Чекбокс согласия уже реализован отдельно и не отмечается заранее.</p>
  `
};
...
document.querySelector('#lead-form').addEventListener('submit',event=>{event.preventDefault();const status=event.currentTarget.querySelector('.form-status');status.textContent='Тестовая версия: заявка пока не отправляется. Перед публикацией подключим доставку на почту.';event.currentTarget.reset()});
